...
ALLOWED_HOSTS = ['192.168.93.114', 'localhost', '127.0.0.1', 'almacenapp.upcv.gob.gt' ]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'libraries': {
                'estado_tags': 'almacen_app.templatetags.estado_tags',
            },
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Almacen',  # Cambia esto por el nombre de tu base de datos
        'USER': 'postgres',
