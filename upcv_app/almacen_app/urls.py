...
urlpatterns = [
    ...
    path('almacen/divisiones/ubicaciones/<int:pk>/desactivar/', views.division_ubicacion_desactivar, name='division_ubicacion_desactivar'),
    path('almacen/divisiones/ubicaciones/<int:pk>/activar/', views.division_ubicacion_activar, name='division_ubicacion_activar'),
    path('almacen/divisiones/ubicaciones/<int:pk>/eliminar/', views.division_ubicacion_eliminar, name='division_ubicacion_eliminar'),
